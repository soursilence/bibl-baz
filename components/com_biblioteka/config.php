...
$dane['lista']['starodruki']=array( 'id' => 'Id starodruki', 'nazwa_pelna' => 'Nazwa pełna', 'tytul' => 'Tytuł', 'tytul_alternatywny' => 'Tytuł alternatywny', 'drukarnia' => 'Drukarnia' , 'drukarnia_alternatywna' => 'Drukarnia alternatywna', 'rok'=>'Rok', 'opis' => 'Opis',  'miejsce' => 'Miejsce', 'kategoria' => 'Kategoria', 
   'data_dodania' =>'data_dodania','indeks' =>'Indeks');
...
$dane['szczegoly']['ksiazki']=array(  'tytul' => 'Tytuł', 'autor' => 'Autor', 'rok'=>'Rok','wydawnictwo' => 'wydawnictwo' ,'ilosc_stron' => 'Ilość stron', 'numer_polki' => 'Numer półki', 
  'miejsce' => 'miejsce', 'temat' => 'Temat', 'data_dodania' =>'data_dodania');
$dane['szczegoly']['starodruki']=array('nazwa_pelna' => 'Nazwa pełna', 'tytul' => 'Tytuł', 'tytul_alternatywny' => 'Tytuł alternatywny', 'drukarnia' => 'Drukarnia' , 'drukarnia_alternatywna' => 'Drukarnia alternatywna', 'rok'=>'Rok', 'opis' => 'Opis', 
   'indeks' =>'Indeks');
   
   $dane['lista_adm']['ksiazki']=array( 'tytul' => 'Tytuł', 'autor' => 'Autor', 'rok'=>'Rok');
$dane['lista_adm']['starodruki']=array('tytul' => 'Tytuł','drukarnia' => 'Drukarnia', 'rok'=>'Rok');
$dane['lista_adm']['autor']=array('nazwa' => 'Nazwa','id' => 'id');
...
$dane['ksiazki']['numer_polki']['properties']['type']="text";
...
$dane['starodruki']['tytul_alternatywny']['element']="input";
$dane['starodruki']['tytul_alternatywny']['type']="str";
$dane['starodruki']['tytul_alternatywny']['properties']['name']="tytul_alternatywny";
$dane['starodruki']['tytul_alternatywny']['properties']['id']="tytul_alternatywny";
$dane['starodruki']['tytul_alternatywny']['properties']['value']="";
$dane['starodruki']['tytul_alternatywny']['properties']['type']="text";
$dane['starodruki']['tytul_alternatywny']['label']="Tytuł alternatywny";
$dane['starodruki']['tytul_alternatywny']['el_end']=false;
...
$dane['starodruki']['nazwa_pelna']['properties']['type']="text";
$dane['starodruki']['nazwa_pelna']['label']="Nazwa pełna";
$dane['starodruki']['nazwa_pelna']['el_end']=true;
...
$dane['starodruki']['drukarnia']['element']="input";
$dane['starodruki']['drukarnia']['type']="str";
...
$dane['starodruki']['drukarnia_alternatywna']['element']="input";
$dane['starodruki']['drukarnia_alternatywna']['type']="str";
$dane['starodruki']['drukarnia_alternatywna']['properties']['name']="drukarnia_alternatywna";
$dane['starodruki']['drukarnia_alternatywna']['properties']['id']="drukarnia_alternatywna";
$dane['starodruki']['drukarnia_alternatywna']['properties']['value']="";
$dane['starodruki']['drukarnia_alternatywna']['properties']['type']="text";
$dane['starodruki']['drukarnia_alternatywna']['label']="Drukarnia alternatywna";
$dane['starodruki']['drukarnia_alternatywna']['el_end']=false;
...
$dane['starodruki']['indeks']['hide']=false;
...
$dane['starodruki']['zalaczniki']['element']="file";
$dane['starodruki']['zalaczniki']['type']="dat";
$dane['starodruki']['zalaczniki']['properties']['value']="";
$dane['starodruki']['zalaczniki']['label']="zalaczniki";
$dane['starodruki']['zalaczniki']['hide']=true;
$dane['starodruki']['zalaczniki']['notedit']=true;
...
$dane['starodruki']['miejsce']['notedit']=true;
...
$dane['starodruki']['kategoria']['notedit']=true;
//return $dane;
?>